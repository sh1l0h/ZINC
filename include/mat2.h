 ...
 *
 * @param mat The 2x2 matrix to be zeroed.
 */
 ...
 *
 * @param mat The 2x2 matrix to be set as an identity matrix.
 */
 ...
 *
 * @param mat The 2x2 matrix to be scaled.
 ...
 *
 * @param mat The 2x2 matrix to multiply with the vector.
 * @param vec The 2D vector to be multiplied with the matrix.
