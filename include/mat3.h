 ...
 *
 * @param[in, out] mat The 3x3 matrix to be zeroed.
 */
 ...
 *
 * @param[in, out] mat The 3x3 matrix to be set as an identity matrix.
 */
 ...
 *
 * @param[in, out] mat The 3x3 matrix to be scaled.
 * @param[out] c The scalar value to scale the matrix by.
 */
 ...
 *
 * @param[in] mat The 3x3 matrix to multiply with the vector.
 * @param[in] vec The 3D vector to be multiplied with the matrix.
